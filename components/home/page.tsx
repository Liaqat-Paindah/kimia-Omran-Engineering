    ...
    >
      <div className="relative h-64 overflow-hidden rounded-sm">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <span className="text-xs text-[#00b3aa] font-mono mb-1 block">
            {category}
          </span>
...
export default function KimiaOmranLanding() {
  const features = [
    {
      ...
      description: "Full-service construction management with quality.",
    },
    {
      icon: <Icons.Engineering />,
      title: "Structural Engineering",
      description:
        "Advanced seismic-resistant solutions using cutting-edge BIM technology.",
    },
    {
      icon: <Icons.Sustainability />,
      title: "Sustainable Solutions",
      description:
        "Eco-friendly construction methods for responsible projects.",
    },
    {
      icon: <Icons.Quality />,
      title: "Quality Control",
      description:
        "Rigorous testing and inspection to ensure highest standards.",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
              Why Choose{" "}
              <span style={{ color: colors.quinary }}>Kimia Omran</span>
            </h2>
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Delivering excellence through innovation, expertise, and
      ...
      <section
        id="projects"
        className="relative py-20 bg-white dark:bg-[#010a12]"
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.a
              ...
              href="/projects"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-sm font-semibold"
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/80 mb-8">
              Let`s discuss how Kimia Omran can bring your vision to life with
              our engineering expertise.
            </p>
            <motion.a
              whileHover={{ scale: 1.05 }}
              href="/contact"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-sm font-semibold text-lg"
